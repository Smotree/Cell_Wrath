...
local function CreateDescriptionPane()
	...
	descText:SetText(
		"|cfffabd2fCell Wrath (Ascension)|r\n"
			...
			.. "|cff78d5ffPorted by|r |cffffffffSmotree|r\n"
			.. "|cffa6e22ePort date|r |cffffffff2025-12-25|r\n\n"
			.. "|cff66ff99Reach me|r\n"
			.. " • |cffffffffDiscord|r: |cff9aedffSmotree|r\n"
			.. " • |cffffffffTests and Bugreports|r: |cff9aedffKol9yN|r\n"
...
local function CreateSupportersPane()
	...
	supportersBtn1:SetScript("OnClick", function()
		if supportersBtn1.fadeOut:IsPlaying() or supportersBtn1.fadeIn:IsPlaying() then
			return
		end
	...
	supportersBtn2:SetScript("OnClick", function()
		if supportersBtn2.fadeOut:IsPlaying() or supportersBtn2.fadeIn:IsPlaying() then
			return
		end
...
local function CreateLinksPane()
	...
	--! curseforge
	local curseforge = CreateLink(
		linksPane,
		"curseforge",
		"Interface\\AddOns\\Cell_Wrath\\Media\\Links\\curseforge.tga",
		function()
	...
	local discord = CreateLink(
		linksPane,
		"discord",
		"Interface\\AddOns\\Cell_Wrath\\Media\\Links\\discord.tga",
		function()
