...
ns.RegisterLocale("ruRU", function()
	...
	L["%s in Utilities must be enabled to make this indicator work."] =
		"%s в Утилитах должно быть включено, что бы этот индикатор работал"
	...
	L["[Ctrl+Left-Click] to reset these settings"] =
		"[Ctrl+Левый Клик] для сброса этих настроек"
	...
	L["|cffffb5c5Right-Click:|r report unaffected"] =
		"|cffffb5c5ПКМ:|r сообщить об отсутствующих баффах"
	L["+ Stack"] = "+ Стак"
	...
	L["About"] = "Об аддоне"
	L["ABOUT"] =
		"Cell - хороший аддон для рейд-фреймов, вдохновленный несколькими великолепными аддонами такими как CompactRaid, Grid2, Aptechka и VuhDo.\n Более удобный интерфейс аддона Cell предоставляет лучший опыт использования, лучше, чем когда-либо.\nНадеюсь, вам понравится."
	L["ACCEPTED"] = "ПРИНЯЛ"
	L["Action"] = "Действие"
	L["Actions"] = "Активности"
	L["Add"] = "Добавить"
	L["Add new spell"] = "Добавить заклинание"
	L["Added |T%d:0|t|cFFFF3030%s(%d)|r into debuff blacklist."] =
		"Добавленно |T%d:0|t|cFFFF3030%s(%d)|r в чёрный список дебаффов."
	L["AFK"] = "АФК"
	...
	L["All indicators of %s will be replaced with those in %s"] =
		"Все индикаторы из %s будут заменены индикаторами из %s"
	L["All snippets have been disabled, due to the version update"] =
		"Все фрагменты были отключены в связи с обновлением версии"
	...
	L["Author"] = "Автор"
	L["Autorun will be disabled for all code snippets"] =
		"Автозапуск будет отключен для всех фрагментов"
	L["Available slash commands"] = "Доступные команды чата"
	L["Background Alpha"] = "Фон: прозрачность"
	L["Background Color"] = "Фон: цвет"
	L["BACKUP_TIPS"] =
		"Бэкапы не всегда надёжны, особенно когда они очень устарели. Рекомендуется периодически создавать бэкапы. При обмене профиля, бэкапы не обрабатываются."
	L["BACKUP_TIPS2"] =
		"Заметка для игроков Классики: бэкапы не включают настройки Привязанных клавиш и Автоматического переключения макета других персонажей "
	L["Backups"] = "Бэкапы"
	L["Bar"] = "Панель"
	...
	L["Buff Tracker icon size is set to %d."] =
		"Размер иконок Бафф Трекера установлен на %d."
	...
	L["Cell will report all deaths during a raid encounter."] =
		"Cell будет сообщать о всех смертях во время боя с рейдовым боссом."
	L["Cell will report first %d deaths during a raid encounter."] =
		"Cell будет сообщать о первой(ых) %d смерти(ях) во время боя с рейдовым боссом."
	L["CENTER"] = "Центр"
	...
	L["Check all visible enemy nameplates."] =
		"Проверять полоски всех видимых противников"
	L["Check If Exists"] = "Проверить, если существует"
	L["Check if your group members need some raid buffs"] =
		"Проверяет, если участники рейда требует какие-либо рейдовые баффы"
	...
	L["Copy indicators from one layout to another"] =
		"Скопировать индикаторы из одного макета в другой "
	L["Create"] = "Создать"
	...
	L["Create several buttons for quick casting and buff monitoring"] =
		"Создаёт несколько кнопок для быстрого каста и слежки за баффами"
	...
	L["Custom indicators will not be overwritten, even with same name"] =
		"Пользовательские индикаторы не будут перезаписаны, даже если у них одинаковые имена"
	...
	L["dispellableByMe"] =
		"Показывать только дебаффы, которые я умею диспеллить"
	L["Dispels"] = "Диспеллы"
	L["Display a gradient texture when the unit receives a heal from your certain healing spells."] =
		"Показывать текстуру с градиентом, когда юнит получает исцеление от некоторых ваших АоЕ заклинаний."
	L["Display elapsed time since debuff applied"] =
		"Показывать время прошедшее с наложения дебаффа"
	L["Display One Decimal Place When"] = "Отображать десятичный знак когда"
	L["Displayed Per Line"] = "Количество в строке"
	L["Do nothing if requested spell/buff already exists on requester"] =
		"Ничего не делать, если запрашиваемое заклинание/бафф уже существует на цели"
	L["DRINKING"] = "ПЬЁТ"
	L["Due to restrictions of the private aura system, this indicator can only use Blizzard style."] =
		"Из-за ограничений системы личных аур, этот индикатор может использовать только стиль Blizzard."
	...
	L['Even if disabled, the settings below affect "Externals + Defensives" indicator'] =
		'Даже если этот индикатор отключен, он всё ещё вливяет на последующие "Внешние сейвы + Персональные кулдауны" индикаторы'
	L["Export"] = "Экспорт"
	L["External Cooldowns"] = "Внешние сейвы"
	L["Externals + Defensives"] = "Внешние сейвы + Персональные кулдауны"
	L["Externals + Defensives, no need to enable all of them"] =
		"Внешние сейвы + Персональные кулдауны, нет необходимости включать их всех"
	...
	L["Glow is only available to the spells in the list below"] =
		"Подсветка доступна только для ниже перечисленных заклинаний"
	L["Glow Options"] = "Параметры подсветки"
	L["Glow Type"] = "Подсветка: тип"
	L["Glow unit button when a group member sends a %s request"] =
		"Подсвечивать фрейм, когда юнит отправляет запрос типа %s"
	L["Glows"] = "Свечения"
	L["Gradient"] = "Градиент"
	...
	L["If disabled, no check, no reply, just glow"] =
		"Если не выбрано, нет проверки и ответа, только свечение "
	L["If you are a paladin or warrior, and the unit has no buffs from you, a %s icon will be displayed."] =
		"Если вы паладин или воин, и у юнита нет ваших баффов, иконка %s будет отображена."
	...
	L["Indicator settings are part of Layout settings which are account-wide."] =
		"Настройки индикаторов являются частью настроек макета, и общие на весь аккаунт."
	...
	L["It will be renamed if this layout name already exists"] =
		"Если макет уже существует, он будет переименован"
	L["Item"] = "Предмет"
	...
	L["Never"] = "Никогда"
	L["New"] = "Новый"
	L["New version found (%s). Please visit %s to get the latest version."] =
		[=[Найдена новая версия (%s). Пожалуйста посетите %s что бы получить новую версию.
]=]
	L["Nickname"] = "Никнейм"
	...
	L["No"] = "Нет"
	L["No custom debuffs to export!"] =
		"Нет пользовательских дебаффов для экспорта!"
	L["No guarantee of the order of members in each subgroup"] =
		"Нет гарантий о порядке участников в каждой подгруппе"
	L["No Spec"] = "Нет спека"
	L["No support for rearrangement of members within a same subgroup"] =
		"Отсутствует поддержка перестановки участников в одной подгруппе"
	L["None"] = "Ничего"
	L["Non-En"] = "Не Англ."
	L["Normal"] = "Обычный"
	...
	L["Only one threshold is displayed at a time"] =
		"Только один из порогов виден в один момент"
	...
	L["Only show when you have permission to do this"] =
		"Показывать только если у вас есть разрешения это делать"
	...
	L["Play animation when the unit uses a specific spell/item. The list is global shared, not layout-specific."] =
		"Показывать анимацию, когда юнит использует конкретное заклинание/предмет. Список глобальный на весь аддон, а не конкретен для макета."
	...
	L["raidRosterTips"] =
		"[ПКМ] что бы повысить/понизить (помощник). [Alt+ПКМ] что бы выгнать"
	L["Ready"] = "Готов"
	...
	L["Remember to backup your profile"] =
		"Не забывайте создавать бэкапы своего профиля"
	L["Remove"] = "Удалить"
	...
	L["Replace click-castings of Spell type with resurrection spells on dead units"] =
		"Заменить использования заклинания нажатием использованием возрождения на мёртвых целях"
	...
	L["Reset"] = "Сбросить"
	L["RESET"] =
		"Cell требует полный сброс после обновление из очень старых версий"
	...
	L["reset Quick Assist for current spec"] =
		"сбросить настройки Ассист Кнопок для текущей специализации"
	L["RESET_CHARACTER"] =
		"Cell требует сброс профиля персонажа после обновления с очень старой версии"
	L["RESET_INCLUDES"] =
		"Только Привязка Клавиш и Автоматическое переключение макета включены"
	L["RESET_YES_NO"] =
		"|cff22ff22Да|r - Сбросить Cell\n|cffff2222Нет|r - Я сам всё исправлю"
	L["Respond to all dispellable debuffs"] = "Отвечать на все рассеиваемые дебаффы"
	L["Respond to all requests from group members"] =
		"Отвечать на все запросы от участников группы"
	L["Respond to requests that are only sent to me"] =
		"Отвечать только на запросы, отправленные мне"
	L["Respond to specific dispellable debuffs"] =
		"Отвечать только на конкретные рассеиваемые дебаффы"
	...
	L["Show friendly NPCs in a separate frame"] =
		"Показывать дружественных НПЦ в отдельной панели"
	...
	L["Show units you care about more in a separate frame"] =
		"Показывает интересующих вас юнитов в отдельной панели"
	...
	L["Shows only one spell request on a unit button at a time"] =
		"Показывает только один запрос заклинания на фрейме юнита за раз"
	...
	L["smooth"] = "Плавная"
	L["SNIPPETS_TIPS"] =
		"[Дважды нажать] что бы переименовать. [Shift-нажать] что бы удалить. Все отмеченные фрагменты кода будут автоматически запущенны в конце процесса инициализации Cell (в ADDON_LOADED событии)."
	L["Solid"] = "Сплошной"
	L["Solo"] = "Соло"
	...
	L["SpellId and BuffId are the same in most cases"] =
		"Зачастую ID заклинаний и баффов одинаковы"
	L["Spells"] = "Заклинания"
	...
	L["The priority of spells decreases from top to bottom."] =
		"Приоритет заклинания снижается сверху вниз."
	L["The spell is required to apply a buff on the target"] =
		"Заклинание должно накладывать бафф на цель"
	L["The spells list of a icons indicator is unordered (no priority)."] =
		'Список заклинаний индикатора "иконок" не имеет порядка (приоритета).'
	L["Then create a PR or submit a ticket on GitHub"] = "Затем создайте PR или тикет на GitHub"
	L['These "reset" commands below affect all your characters in this account'] =
		'Последующие "reset" команды влияют на всех персонажей вашего аккаунта'
	L["These settings are spec-specific"] =
		"Эти настройки индивидуальны для каждой специализации"
	L["Thickness"] = "Толщина"
	L["This may help solve issues of indicators not updating correctly"] =
		"Эта настройка может помочь решить проблемы с обновлениями некоторых индикаторов"
	L["This may overwrite built-in indicators"] =
		"Эта настройка может перезаписать встроенные индикаторы"
	L["This setting will be ignored, if the %1$s option in %2$s tab is enabled"] =
		"Эта настройка будет проигнорирована, если настройка %1$s во вкладке %2$s активно"
	L["This will make these icons not click-through-able"] =
		"Это сделает эти иконки не прокликиваемыми сквозь"
	...
	L["Timeout"] = "Таймаут"
	L["Tip: Every layout has its own position setting"] =
		"Совет: Каждый макет имеет свои настройки расположения"
	L["Tip: right-click to delete"] = "Совет: ПКМ что бы удалить"
	L["To"] = "К"
	L["To HealthBar's"] = "Относительно панели"
	L["To open options frame, use /cell options"] =
		"Что бы открыть настройки, используйте команду /cell options"
	L["To show shield value, |cffff2727Glyph of Power Word: Shield|r is required"] =
		"Что бы показывать значение щита, необходим  |cffff2727Символ слова силы: Щит|r "
	L["To transfer across realm, you need to be in the same group"] =
		"Что бы передавать через реалмы, нужно быть в одной группе"
	...
	L["Tooltips need to be enabled in General tab"] =
		'Подсказка должна быть включена в настройках "Основное" '
	L["TOP"] = "Верх"
	L["TOPLEFT"] = "Лево-Верх"
	...
	L["Use |cFFFFB5C5/cell buff X|r to set icon size"] =
		"Используйте команду |cFFFFB5C5/cell buff X|r, что бы выставить размер иконок"
	L["Use |cFFFFB5C5/cell report X|r to set the number of reports during a raid encounter"] =
		"Используйте |cFFFFB5C5/cell report X|r что бы установить количество отчётов во время боя с рейдовым боссом"
	L["Use CLEU events to increase health update rate"] =
		"Использовать ивенты CLEU для обновления здоровья"
	...
	L["Use Same Arrangement As Main"] =
		"Использовать расположения Основной панели"
	L["Use Same Size As Main"] =
		"Использовать настройки размеров Основной панели"
	L["use separate profile for current spec"] =
		"использовать отдельный профиль для текущей специализации"
	L["Use separate profile for each spec"] =
		"Использовать отдельный профиль для каждой специализации"
	L["Utilities"] = "Утилиты"
	L["VEHICLE"] = "Транспорт"
	...
	L['Would you like Cell to create a "Healers" indicator (icons)?'] =
		'Хотели бы вы чтобы Cell создал "Хилерские" индикаторы (иконки)?'
