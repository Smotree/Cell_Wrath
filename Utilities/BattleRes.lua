...
-- bar
--------------------------------------------------
local bar = Cell.CreateStatusBar(
	"CellBattleResBar",
	battleResFrame,
	10,
	4,
	...
	nil,
	false,
	"Interface\\AddOns\\Cell_Wrath\\Media\\statusbar",
	Cell.GetAccentColorTable()
)
...
battleResMover.text:SetPoint("LEFT", 2, 0)
battleResMover.text:SetPoint("RIGHT", -2, 0)
battleResMover.text:SetWordWrap(false)
